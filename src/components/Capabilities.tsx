...
export default function Capabilities() {
  return (
    <section 
      id="services" 
      className="relative h-full w-full flex items-start justify-start px-6 sm:px-12 md:px-16 lg:px-20 pt-24 sm:pt-28 md:pt-32 pb-8 sm:pb-12 md:pb-16 select-none overflow-hidden"
    >
