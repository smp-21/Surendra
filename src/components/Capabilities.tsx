      ...
      <div className="hidden md:flex h-full w-full items-center justify-center md:justify-start px-4 md:px-16 lg:px-20 py-8 lg:py-12">
        <Link href="/services" className="pointer-events-auto block cursor-pointer group">
          <motion.div 
            ...
            className="bg-charcoal/65 border border-white/[0.05] backdrop-blur-xl p-6 sm:p-10 lg:p-12 w-fit max-w-[90vw] sm:max-w-xl md:max-w-2xl lg:max-w-3xl rounded-xl shadow-lg transition-all duration-500 group-hover:border-bronze/40 group-hover:bg-charcoal/70 group-hover:shadow-lg relative"
          >
