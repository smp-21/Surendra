  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(176,144,112,0.08)_0%,rgba(20,24,32,0.3)_50%,transparent_100%)] pointer-events-none" />
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-8 z-10 pointer-events-none">
        ...
        >
          ...
          <div className="hidden lg:flex hero-top-badge items-center gap-3 border border-white/[0.04] bg-charcoal/60 p-2 px-5 backdrop-blur-md shadow-lg mb-5 sm:mb-6 rounded-lg">
            {/* Liquid Platinum active indicator LED */}
            <div className="w-1 h-1 bg-bronze/50 rounded-full shrink-0" />
            <span className="font-sans text-[11px] sm:text-xs tracking-[0.12em] text-zinc-400 uppercase font-medium">
              MASTER COACHBUILDERS
            </span>
          </div>

          {/* Massive Centered Title - Scaled to fit perfectly on a single line on all displays */}
          <h1 className="font-serif text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-[9rem] font-bold tracking-[0.03em] sm:tracking-[0.06em] text-white uppercase mb-2 sm:mb-3 leading-[0.9] select-text shimmer-text w-full text-center whitespace-nowrap">
            SURENDRA & CO.
          </h1>
          
          {/* Re-engineered Editorial Tagline Division - Sandblasted Titanium & Liquid Platinum */}
          <div className="flex items-center justify-center gap-3 sm:gap-5 font-sans text-[10px] sm:text-xs md:text-sm tracking-[0.1em] sm:tracking-[0.14em] uppercase font-medium bg-charcoal/70 border border-white/[0.04] px-5 sm:px-8 py-2.5 sm:py-3.5 backdrop-blur-xl shadow-md mt-3 sm:mt-4 max-w-[90vw] sm:max-w-none flex-wrap select-text rounded-lg">
