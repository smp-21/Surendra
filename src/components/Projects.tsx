...
export default function Projects() {
  return (
    ...
    >
      ...
      <div className="hidden md:flex h-full w-full items-center justify-center md:justify-end px-4 md:px-16 lg:px-20 py-8 lg:py-12">
      ...
      <div className="flex md:hidden h-full w-full flex-col justify-between py-8 px-6 relative">
        ...
        <Link href="/range" className="pointer-events-auto block cursor-pointer group w-full h-full flex flex-col justify-between">
          ...
          <div className="w-full aspect-video relative shrink-0 my-4 pointer-events-none flex items-center justify-center">
            ...
            {/* HUD Status labels */}
            <div className="absolute top-2 left-3 font-mono text-[7px] text-bronze/35 tracking-wider uppercase">HUD_SYS // CONFIG</div>
            <div className="absolute bottom-2 right-3 font-mono text-[7px] text-bronze/35 tracking-wider uppercase font-bold">CAM // 03</div>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-center items-center px-2">
            ...
            >
              <p className="text-zinc-200 text-[13px] font-light tracking-wide leading-relaxed mb-4 text-center">
                Custom heavy coaches built on certified Volvo chassis platforms.
              </p>
