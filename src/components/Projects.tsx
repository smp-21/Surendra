...
export default function Projects() {
  return (
    <section 
      id="range" 
      className="relative h-full w-full flex items-center justify-end px-6 sm:px-12 md:px-16 lg:px-20 py-8 sm:py-12 md:py-16 lg:py-20 select-none overflow-hidden"
    >
