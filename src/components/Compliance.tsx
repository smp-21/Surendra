...
export default function Compliance() {
  return (
    <section 
      id="compliance" 
      className="relative h-full w-full flex items-center sm:items-end justify-center sm:justify-end px-4 sm:px-12 md:px-16 lg:px-20 py-4 sm:py-8 lg:py-12 select-none overflow-hidden"
    >
