      ...
      <div className="hidden md:flex h-full w-full items-center justify-center px-4 md:px-16 lg:px-20 py-8 lg:py-12">
        <Link href="/process" className="pointer-events-auto block cursor-pointer group">
          <motion.div 
            ...
            className="bg-white/80 border border-black/[0.05] backdrop-blur-xl p-6 sm:p-10 lg:p-12 w-fit max-w-[90vw] sm:max-w-xl md:max-w-2xl lg:max-w-3xl rounded-xl shadow-lg transition-all duration-500 group-hover:border-bronze/40 group-hover:bg-white/85 group-hover:shadow-lg text-center relative"
          >
