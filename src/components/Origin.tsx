...
export default function Origin() {
  return (
    <section 
      id="origin" 
      className="relative h-full w-full flex items-center sm:items-end justify-center sm:justify-start px-4 sm:px-12 md:px-16 lg:px-20 py-4 sm:py-8 lg:py-12 select-none overflow-hidden"
    >
