...
export default function Origin() {
  return (
    <section 
      id="origin" 
      className="relative h-full w-full flex items-end justify-start px-6 sm:px-12 md:px-16 lg:px-20 py-8 sm:py-12 md:py-16 lg:py-20 select-none overflow-hidden"
    >
